    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ลักษณะการเล่าเรื่องของนิทานเรื่องนี้ เป็นแบบใด",
                    choices: [
                        "กาพย์ฉบัง",
                        "กลอนสุภาพ",
                        "โคลงสี่สุภาพ",
				...
				{
					question: "2. เมืองมหาสารคามอยู่ทางภาคใดของไทย",
                    choices: [
                        "ภาคเหนือ",
				...
				{
					question: "3. หากต้องการไหว้พระธาตุที่มหาสารคามเราต้องไปที่ใด",
                    choices: [
                        "พระธาตุพนม",
                        "พระธาตุนาดูน",
                        "พระธาตุเชิงชุม",
				...
				{
					question: "4. แม่น้ำสายใดไหลผ่านเมืองมหาสารคาม",
                    choices: [
                        "แม่น้ำปิง",
                        "แม่น้ำชี",
                        "แม่น้ำมูล",
				...
				{
					question: "5. ข้อใดถูกต้อง",
                    choices: [
                        "ปูเจ้าฟ้ามีอีกชื่อหนึ่งคือปูจุฬาภรณ์",
                        "ดอกคูนที่มหาสารคามมีสีส้มปนขาว",
                        "มีสะดืออีสานอยู่สองแห่งในเมืองน",
						"เสื่อของมหาสารคามได้ชื่อว่ามีผืนใหญ่ที่สุด"
                    ],
                    correct: 1
				},
				{
					question: "6. ''มีปูเจ้าฟ้า เอิ้นจุฬาภรณ์'' คำว่า 'เอิ้น' หมายถึงอะไร",
                    choices: [
                        "เรียกว่า",
                        "ถามว่า",
                        "ชมว่า",
				...
				{
					question: "7. ''ทายสิเมืองหยัง   คึด คึด หื้อ ออก'' คำว่า 'คึด คึด' หมายถึงอะไร",
                    choices: [
                        "คิด",
                        "ตอบ",
                        "ร้องเพลง",
				...
				{
					question: "8. ข้อใดสัมพันธ์กัน",
                    choices: [
                        "เสื่อ : บ้านแพง",
                        "ผ้าทอ : แม่น้ำชี",
                        "กระเป๋า :  เจ้าฟ้า",
						"ตะกร้า : หนองเขื่อนช้าง"
                    ],
                    correct: 1
				},
				{
					question: "9. เพราะเหตุใด เมืองมหาสารคามจึงได้ชื่อว่า ''ตักศิลานคร” แห่งภาคอีสาน''",
                    choices: [
                        "เพราะเป็นแหล่งความรู้ด้านการเลี้ยงสัตว",
                        "เพราะเป็นที่ตั้งของสถานศึกษาหลายแห่ง",
                        "เพราะเป็นแหล่งท่องเที่ยวทางประวัติศาสตร",
						"เพราะเป็นที่ตั้งของหมู่บ้านทอผ้าที่ใหญ่ที่สุด"
                    ],
                    correct: 2
				},
				{
					question: "10. นิทานเรื่องนี้บอกเล่าเกี่ยวกับสิ่งใด",
                    choices: [
                        "วิถีชีวิตของคนมหาสารคาม",
                        "อาชีพหลักของคนมหาสารคาม",
                        "ดอกไม้ประจำเมืองมหาสารคาม",
						"สิ่งที่น่าสนใจของเมืองมหาสารคาม"
                    ],
                    correct: 4
				}
                ],
