    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ดอกสร้อยสุภาษิตตอน “เด็กน้อย” สอนให้เด็ก ๆ ทำเรื่องใดเป็นสิ่งสำคัญ",
                    choices: [
                        "ทำงานบ้าน",
                        "เล่นกับเพื่อน",
                        "ขยันเรียน"
				...
				{
					question: "2. เด็ก ๆ ควรเอานิสัยดีด้านใดของแมวเป็นแบบอย่าง",
                    choices: [
                        "ความอดทน",
                        "ความกตัญญู",
                        "รักพวกพ้อง"
				...
				{
					question: "3. เราควรใช้เวลาทำอะไรให้เป็นประโยชน์",
                    choices: [
                        "ทำงานบ้าน",
                        "หาวิธีตั้งไข่",
                        "ตั้งใจเรียนหนังสือ"
				...
				{
					question: "4. นกขมิ้นออกหากินเวลาใด",
                    choices: [
                        "เวลาเช้า",
                        "เวลาเที่ยง",
                        "เวลาเย็น"
				...
				{
					question: "5. ตุ๊ดตู่มีนิสัยอย่างไร ที่เราไม่ควรเอาเป็นแบบอย่าง",
                    choices: [
                        "เกเร",
                        "ขี้เกียจ",
                        "ขี้ขโมย"
				...
				{
					question: "6. ''ไก่แจ้ตื่นขึ้นมาขันทุก ๆ เช้าไม่เคยบ่น'' แปลว่าไก่แจ้มีลักษณะนิสัยอย่างไร",
                    choices: [
				...
				{
					question: "7. กาดำเป็นแบบอย่างที่ดีในเรื่องใด",
                    choices: [
                        "ขยัน",
                        "รักพวกพ้อง",
                        "เอื้อเฟื้อ"
				...
				{
					question: "8. ข้อใดแสดงถึงความสามัคคีของมด",
                    choices: [
                        "เมื่อมดหาอาหารได้ จะแบ่งกันกิน",
                        "เวลาเดินไปไหน มดจะเดินเป็นแถว",
                        "เมื่อมีศัตรูมาทำร้าย มดจะช่วยกันต่อส"
                    ],
                    correct: 3
				},
				{
					question: "9. ทำไมลูกควรตอบแทนพระคุณของแม่",
                    choices: [
                        "แม่พาเราไปเที่ยวบ่อยๆ",
                        "แม่ให้เงินค่าขนมเราทุกวัน",
                        "แม่เลี้ยงดูเราตั้งแต่เล็กจนโต"
                    ],
                    correct: 3
				},
				{
					question: "10. ''คนที่รีบกินข้าวเพื่อให้คนกินเสร็จทีหลังล้างจาน'' แปลว่าเป็นคนนิสัยอย่างไร",
                    choices: [
                        "ใจร้อน",
                        "เอาเปรียบ",
                        "เกเร"
