    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. “ขนฟู หูยาว และขาวนวล” หมายถึงสัตว์ตัวใด",
                    choices: [
                        "หมี",
                        "วัว",
                        "กระต่าย"
				...
				{
					question: "2. ครอบครัวกระต่ายมีกระต่ายกี่ตัว",
                    choices: [
                        "3 ตัว",
                        "5 ตัว",
                        "6 ตัว"
				...
				{
					question: "3. ขนฟู หูยาว และขาวนวลต่อเติมบ้านเพื่ออะไร",
                    choices: [
                        "บ้านหลังเก่าผุพัง",
                        "พ่อแม่ขอให้สร้าง",
                        "ขยายพื้นที่บ้าน"
				...
				{
					question: "4. พี่นกให้กำลังใจขาวนวลว่าอย่างไร",
                    choices: [
                        "ช่วยเท่าที่ทำได้",
                        "ต้องกล้าแสดงออก",
                        "ลองพยายามอีกครั้ง"
				...
				{
					question: "5. ทำไมแปลงผักของครอบครัวกระต่ายจึงเสียหาย",
                    choices: [
                        "น้ำท่วม",
                        "ฝนตกหนัก",
                        "โดนสัตว์อื่นทำลาย"
				...
				{
					question: "6. รั้วหญ้าแฝกมีประโยชน์กับครอบครัวกระต่ายอย่างไร",
                    choices: [
                        "ช่วยยึดหน้าดิน",
                        "ป้องกันน้ำท่วม",
                        "ดินอุดมสมบูรณ์"
				...
				{
					question: "7. “เมื่อรู้ว่ากระต่ายสามพี่น้องต่อเติมบ้าน เพื่อน ๆ สัตว์ก็มาช่วยสร้างด้วย” แปลว่าเพื่อน ๆ สัตว์มีนิสัยอย่างไร",
                    choices: [
                        "มุ่งมั่น",
                        "มีน้ำใจ",
                        "ขยันขันแข็ง"
				...
				{
					question: "8. อะไรทำให้กระต่ายทั้งสามสร้างบ้านเสร็จ",
                    choices: [
                        "ความรับผิดชอบ",
                        "ลูกกระต่ายขยันขันแข็ง",
                        "ลูกกระต่ายมีความรอบคอบ"
                    ],
                    correct: 2
				},
				{
					question: "9. ทำไมพ่อแม่กระต่ายจึงภูมิใจในตัวลูกกระต่าย",
                    choices: [
                        "ลูกกระต่ายมีความสามัคคี",
                        "ลูกกระต่ายขยันขันแข็ง",
                        "ลูกกระต่ายมีความรอบคอบ"
                    ],
                    correct: 1
				...
				{
					question: "10. ข้อใดไม่ใช่ที่อยู่ของกระต่าย",
                    choices: [
                        "ในป่า",
                        "บึงน้ำ",
                        "โพรงต้นไม้"
