    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ครอบครัวของชะเอมมีใครบ้าง",
                    choices: [
                        "พ่อ แม่ และชะเอม",
                        "แม่ แม่ ชะเอม และชะอม",
                        "พ่อ แม่ ชะเอม ชะอม และยาย"
                    ],
                    correct: 2
				},
				{
					question: "2. พ่อกับแม่พาชะอมกับชะเอมไปเที่ยวที่ไหน",
                    choices: [
                        "ตลาด",
                        "สวนสัตว์",
                        "ห้างสรรพสินค้า"
				...
				{
					question: "3. ชะเอกบอกพ่อกับแม่ให้หาเงินจากที่ไหนมาซื้อของ",
                    choices: [
                        "ยืมเงินคุณยาย",
                        "กดเงินจากตู้เอทีเอ็ม",
                        "รีบกลับบ้านไปเอาเงินมาอีก"
                    ],
                    correct: 2
				},
				{
					question: "4. ข้อใดไม่ใช่เหตุการณ์ในฝันของชะเอม",
                    choices: [
                        "ชะเอมเปิดไฟในห้องไม่ติด",
                        "พ่อแม่พาชะเอมไปซื้อของ",
                        "ชะเอมร้องหาพ่อแม่ทั่วบ้าน"
                    ],
                    correct: 2
				},
				{
					question: "5. “เมื่อกินขนมไม่หมด ชะเอมกับชะอมจะทิ้งไป แล้วซื้อใหม่” แปลว่าทั้งสองคนมีนิสัยอย่างไร",
                    choices: [
                        "เลือกกิน",
                        "ชอบซื้อของ",
                        "กินทิ้งกินขว้าง"
				...
				{
					question: "6. เด็ก ๆ จะแนะนำชะเอมให้ช่วยพ่อแม่ประหยัดอย่างไร",
                    choices: [
                        "ซื้อเท่าที่จำเป็น",
                        "ไม่รังแกน้องชาย",
                        "ตั้งใจเรียนหนังสือ"
				...
				{
					question: "7. นิทานเรื่อง “ความฝันของชะเอม” ให้ข้อคิดในเรื่องใด",
                    choices: [
                        "ความรักของพ่อแม่",
                        "การใช้เงินอย่างคุ้มค่า",
                        "การเลือกซื้อของที่ตลาด"
                    ],
                    correct: 2
				},
				{
					question: "8. หากเด็กๆ อยากได้ของเล่นชิ้นใหม่ จะทำอย่างไร",
                    choices: [
                        "ขอจากเจ้าของร้าน",
                        "บอกคุณแม่ให้ซื้อให้",
                        "เก็บเงินซื้อด้วยตัวเอง"
                    ],
                    correct: 3
				},
				{
					question: "9. เราควรเลือกซื้อของอย่างไร",
                    choices: [
                        "ซื้อของที่จำเป็น",
                        "ซื้อแต่ของที่ชอบ",
                        "ซื้อของลดราคา"
				...
				{
					question: "10. เราควรทำอย่างไรเมื่อกินขนมหรืออาหารไม่หมด",
                    choices: [
                        "เอาไปทิ้ง",
                        "แบ่งให้เพื่อนกิน",
                        "เก็บใส่ถุงหรือกล่อง"
