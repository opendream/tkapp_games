    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ทำไมเพื่อน ๆ จึงไม่อยากเล่นกับหนูดี",
                    choices: [
                        "หนูดีพูดไม่เพราะ",
                        "หนูดีชอบทำหน้าบึ้ง",
                        "หนูดีไม่อยากมีเพื่อน"
                    ],
                    correct: 2
				},
				{
					question: "2. พ่อกับแม่ใช้วิธีใดหาคนมาช่วยทำให้หนูดียิ้ม",
                    choices: [
                        "แจกใบปลิวตามหา",
                        "แจ้งข่าวผ่านอินเทอร์เน็ต",
                        "ประกาศผ่านหนังสือพิมพ์"
                    ],
                    correct: 3
				},
				{
					question: "3. หนูดีไปอยู่กับป้าส้มลิ้มนานเท่าไหร",
                    choices: [
                        "2 สัปดาห์",
                        "4 สัปดาห์",
                        "2 เดือน"
				...
				{
					question: "4. ใครไม่ใช่เพื่อนของหนูดี",
                    choices: [
                        "นิดหน่อย",
                        "น้อยหน่า",
                        "น้ำหนึ่ง"
				...
				{
					question: "5. สองสัปดาห์แรก หนูดีช่วยป้าส้มลิ้มทำอะไร",
                    choices: [
                        "ขายของ",
                        "รดน้ำต้นไม้",
                        "ทำงานบ้าน"
				...
				{
					question: "6. การใช้ชีวิตร่วมกับผู้อื่น ทำให้หนูดีเปลี่ยนแปลงอย่างไร",
                    choices: [
                        "พูดจาไพเราะขึ้น",
                        "ตัวสูง ร่างกายแข็งแรง",
                        "มีรอบยยิ้ม สดใสขึ้น"
                    ],
                    correct: 3
				},
				{
					question: "7. ทุกคนรู้สึกอย่างไรเมื่อเห็นรอยยิ้มของหนูด",
                    choices: [
                        "ปลื้มใจ",
                        "โล่งใจ",
                        "ตื่น"
				...
				{
					question: "8. เมื่อหนูดีกลับบ้าน เด็ก ๆ คิดว่าหนูดีจะเปลี่ยนแปลงไปอย่างไร",
                    choices: [
                        "หน้าบึ้งเหมือนเดิม",
                        "มีเพื่อนมาเล่นด้วย",
                        "ขอให้พ่อกับแม่ซื้อของเล่น"
                    ],
                    correct: 2
				},
				{
					question: "9.ป้าส้มลิ้มสอนอะไรให้หนูด",
                    choices: [
                        "พูดจาไพเราะ",
                        "ขยันขันแข็ง",
                        "ช่วยเหลือตนเองและผู้อื่น"
                    ],
                    correct: 3
				},
				{
					question: "10. ถ้าเด็ก ๆ มีของเล่นมากมายเด็ก ๆ จะทำอย่างไร",
                    choices: [
                        "เก็บใส่กล่อง",
                        "แบ่งเพื่อน",
                        "วางตกแต่งห้อง"
