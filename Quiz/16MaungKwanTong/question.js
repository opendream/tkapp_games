    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ใครเล่านิทานเรื่องนี้",
                    choices: [
                        "คูน",
                        "รุ้งกินน้ำ",
                        "คูน และ น้อยหน่า"
				...
				{
					question: "2. เมืองขวานทองเรียกได้อีกชื่อหนึ่งว่าอะไร",
                    choices: [
                        "เมืองใจดี",
                        "เมืองสีทอง",
                        "เมืองยิ้มสยาม"
				...
				{
					question: "3. ชาวบ้านยิงบั้งไฟเพื่ออะไร",
                    choices: [
                        "เพื่อให้ฝนตก",
                        "บอกเวลาเกี่ยวข้าว",
                        "เพื่อความสนุกสนาน"
				...
				{
					question: "4. ''เรือกอและ'' อยู่ทางภาคใดของประเทศไทย",
                    choices: [
                        "ภาคเหนือ",
                        "ภาคกลาง",
                        "ภาคใต้"
				...
				{
					question: "5. ''มัสยิด'' เป็นสถานที่สำคัญของศาสนาใด",
                    choices: [
                        "พุทธ",
                        "คริสต์",
                        "อิสลาม"
				...
				{
					question: "6. บ้านเรือนไทยที่บนจั่วจะติดไม้กาแลไว้ เป็นลักษณะเรือนของภาคใด",
                    choices: [
                        "ภาคเหนือ",
                        "ภาคกลาง",
                        "ภาคใต้"
				...
				{
					question: "7. รุ้งกินน้ำไม่ได้พาเด็ก ๆ ไปเที่ยวที่ไหน",
                    choices: [
                        "ดอยตุง",
                        "ปราสาทหิน",
                        "วัดพระแก้ว"
				...
				{
					question: "8. เราสามารถเห็นรุ้งกินน้ำได้ในเวลาใด",
                    choices: [
                        "เช้ามืด",
                        "หลังฝนตก",
                        "ตอนเที่ยงคืน"
				...
				{
					question: "9.ข้อคิดที่ได้จากนิทานเรื่องนี้คือ",
                    choices: [
                        "ควรรักและภูมิใจในชาติไทย",
                        "สถานที่ท่องเที่ยวมีอยู่รอบตัว",
                        "เราควรท่องเที่ยวในประเทศไทย"
                    ],
                    correct: 1
				},
				{
					question: "10. เด็ก ๆ จะช่วยอนุรักษ์วัฒนธรรมไทยได้อย่างไรบ้าง",
                    choices: [
                        "กอดเพื่อนเมื่อเจอกัน",
                        "พนมมือไหว้สวัสดี",
                        "นั่งรถประจำทางไปโรงเรียน"
                    ],
                    correct: 2
				}
                ],
