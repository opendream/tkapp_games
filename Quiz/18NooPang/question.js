    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ตุ๊กตายิ้มแฉ่งของหนูแป้งไม่ได้ประดิษฐ์จากสิ่งใด",
                    choices: [
                        "ฟองน้ำ",
                        "ขวดแก้ว",
                        "ถุงเท้าเก่า"
				...
				{
					question: "2. กล่องนมสามารถนำมาผลิตเป็นอะไรได้ใหม่",
                    choices: [
                        "กระถางต้นไม้",
                        "หนังสืออักษรเบลล์",
                        "กระดาษอัดกรีนบอร์ด"
				...
				{
					question: "3. ห่วงเปิดกระป๋องเครื่องดื่มสามารถนำมาหลอมเป็นอะไรได้",
                    choices: [
                        "ขาเทียม",
                        "พวงกุญแจ",
                        "กระปุกออมสิน"
				...
				{
					question: "4. ขอใดไม่ใช่สิ่งที่หนูแป้งทำเมื่อมีเวลาว่าง",
                    choices: [
                        "แยกขยะส่งลุงซาเล้ง",
                        "กวนมะม่วงขาย",
                        "ทำข้าวต้มมัดแจกเพื่อนบ้าน"
                    ],
                    correct: 3
				},
				{
					question: "5. ไม้กวาดทางมะพร้าวทำมาจากอะไร",
                    choices: [
                        "ใบมะพร้าว",
                        "ลูกมะพร้าว",
                        "ก้านมะพร้าว"
				...
				{
					question: "7. ขวดน้ำดื่มสามารถนำมาดัดแปลงเป็นอะไรได้",
                    choices: [
                        "ไม้กลัด",
                        "ปุ๋ยปลูกต้นไม้",
                        "กระถางปลูกต้นไม้"
				...
				{
					question: "8. คำว่า “แปลงขุมทรัพย์” จากนิทานเรื่องนี้หมายถึงอะไร",
                    choices: [
                        "การซื้อของมาขาย",
                        "กสนเอาของไปบริจาค",
                        "การดัดแปลงของเหลือใช้"
                    ],
                    correct: 3
				},
				{
					question: "9. “หนูแป้งแปลงสิ่งต่างๆ ให้มีประโยชน์” ข้อใดไม่เหมาะกับหนูแป้ง",
                    choices: [
                        "ตระหนี่",
                        "มีความพยายาม",
                        "กวาดบ้าน"
				...
				{
					question: "10. เด็ก ๆ สามารถช่วยคุณพ่อคุณแม่ทำอะไรได้บ้าง",
                    choices: [
                        "รีดผ้า",
                        "ทำกับข้าว",
                        "กวาดบ้าน"
