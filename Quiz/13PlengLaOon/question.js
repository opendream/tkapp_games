    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. เพลงละอ่อนขึ้นต้นด้วยคำใด",
                    choices: [
                        "โอ้ละหนอ",
                        "นอนสาหล่า",
                        "ติ่ง ลิง ติง",
				...
				{
					question: "2. เพลงละอ่อนเป็นนิทานที่เล่าด้วยภาษาใด",
                    choices: [
                        "ภาษาใต้",
                        "ภาษาเหนือ",
                        "ภาษาอีสาน",
				...
				{
					question: "3. “อื่อ อื่อ จา จา ...	หลับสองตาอย่าไห้ \
								แก้วแก่นไท้ 	แม่จะอื่อ จา จา” \
					กลอนบทนี้แสดงให้เห็นสิ่งใด",
                    choices: [
                        "ลักษณะนิสัยของเด็กทารก",
                        "ประเพณีพื้นบ้านของเด็กทารก",
                        "ความรักและความห่วงใยของพ่อแม่",
						"ความเชื่อในสิ่งศักดิ์สิทธิ์ของคนในชุมชน"
                    ],
                    correct: 3
				},
				{
					question: "4. “กลองสะบัดชัย		กลองแอวสิ้งหม้อง \
								หมู่พี่หมู่น้อง 		ม่วนแท้ม่วนว่า” \
					คำในข้อใดมีความหมายเดียวกับคำว่า 'ม่วนแท้ม่วนว่า'",
                    choices: [
                        "สนุกสนานมาก",
                        "เสียงดังอึกทึก",
                        "ปรบมือโห่ร้อง",
				...
				{
					question: "5. ''พี่น้องเหย		ไปแอ่วกาดหมั้ว \
								ไปซื้อครัว	 	เข้าหนมเข้าต้ม'' \
					คำว่า 'กาด' แปลว่าอะไร",
                    choices: [
                        "วัด",
                        "ตลาด",
                        "บ้าน",
				...
				{
					question: "6. ข้อใดเป็นเครื่องดนตรีของล้านนา",
                    choices: [
                        "ฉิ่ง",
                        "ขลุ่ย",
                        "ซออู้",
				...
				{
					question: "7. ข้อใดคือการแสดงที่เป็นเอกลักษณ์ของภาคเหนือ",
                    choices: [
                        "การเซิ้ง",
                        "การฟ้อนเล็บ",
                        "การรำมโนรา",
				...
				{
					question: "8. จังหวัดใดต่อไปนี้ ใช้ภาษาเหนือเหมือนในนิทาน ''เพลงละอ่อน'' ",
                    choices: [
                        "กาญจนบุรี",
                        "ชัยนาท",
                        "ตราด",
				...
				{
					question: "9. ข้อใดกล่าวถึง ''เพลงละอ่อน'' ได้ใกล้เคียงที่สุด",
                    choices: [
                        "เพลงบรรเลง",
                        "เพลงร้องคู่",
                        "เพลงเห่เรือ",
				...
				{
					question: "10. เพลงละอ่อนสะท้อนคุณค่าด้านใด",
                    choices: [
                        "คุณธรรมที่ควรมีประจำตัว",
                        "ความเชื่อเรื่องเก็บเกี่ยวพืชผล",
                        "การท่องเที่ยวของคนในชุใชน",
						"วิถีชีวิตและวัฒนธรรมของคนในชุมชน"
                    ],
                    correct: 4
				}
                ],
