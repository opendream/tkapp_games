    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. เจ๊หมวยเปิดร้านอะไร",
                    choices: [
                        "ร้านขายของชำ",
                        "ร้านเสริมสวย",
                        "ร้านขายผลไม้"
				...
				{
					question: "3. ''ยักษ์ปักษ์หลั่น'' คือคนที่มีลักษณะอย่างไร",
                    choices: [
                        "คนที่มีเขี้ยว",
                        "ตัวใหญ่ แข็งแรง",
                        "คนที่หน้าตาน่ากลัว"
				...
				{
					question: "4. ซีงอมีหน้าที่ทำอะไร",
                    choices: [
                        "หาที่อยู่ให้สัตว์ที่มาใหม่",
                        "หาอาหารให้สัตว์อื่นๆ",
                        "ดูแลปกป้องสัตว์ทุกตัวในป่า"
                    ],
                    correct: 3
				},
				{
					question: "5. ซีงอทำอะไรต่อเมื่อคาซีจับช้างเชือกหนึ่งไปกิน",
                    choices: [
                        "วางแผนฆ่ายักษ์คาซี",
                        "หาที่อยู่ใหม่ให้บรรดาสัตว์",
                        "เรียกประชุมสัตว์ทุกตัว"
                    ],
                    correct: 3
				},
				{
					question: "6. ซีงอบอกให้สัตว์อื่นหนีไป และยอมเป็นอาหารของยักษ์เอง แสดงถึงคุณธรรมด้านใด",
                    choices: [
                        "ความมีน้ำใจ",
                        "การเสียสละ",
                        "ความรับผิดชอบ"
				...
				{
					question: "7. ''เจ้าป่า'' หมายถึงสัตว์ตัวใด",
                    choices: [
                        "ช้าง",
                        "เสือ",
                        "สิงโต"
				...
				{
					question: "8. สัตว์ทุกตัวทำอย่างไรเมื่อซีงอยอมเป็นอาหารให้คาซ",
                    choices: [
                        "หนีออกจากป้า",
                        "ยอมสละตนเป็นเหยื่อแทน",
                        "เอาอาหารมาให้ซีงอ"
                    ],
                    correct: 2
				},
				{
					question: "9. ''ไข่นุ้ยซักถามเป๊าะจิ๊ไม่หยุดปาก'' แปลว่าไข่นุ้ยเป็นเด็กอย่างไร",
                    choices: [
                        "มุ่งมั่น",
                        "ขี้สงสัย",
                        "กระตือรือร้น"
				...
				{
					question: "10. สังคมที่ทุกคนรักและสามัคคีกันจะเป็นอย่างไร",
                    choices: [
                        "สงบสุข",
                        "สะอาด",
                        "อุดมสมบูรณ์"
