    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. นิทานเรื่องนี้บรรยายเกี่ยวกับสิ่งใด",
                    choices: [
                        "ภูมิศาสตร์ของเมืองเชียงใหม",
                        "สิ่งที่น่าสนใจของเมืองเชียงใหม",
                        "การเดินทางไปเที่ยวเมืองเชียงใหม่",
						"สถานที่ท่องเที่ยวสำคัญของเมืองเชียงใหม่"
                    ],
                    correct: 2
				},
				{
					question: "2. แม่น้ำสายใดไหลผ่านเมืองเชียงใหม่",
                    choices: [
                        "ปิง",
                        "วัง",
                        "ยม",
				...
				{
					question: "3. ข้อใดเป็นสัญลักษณ์สำคัญของเมืองเชียงใหม",
                    choices: [
                        "ดอยสุเทพ",
                        "แม่น้ำปิง",
                        "วัดพระสิงห์",
				...
				{
					question: "4. ข้อใดกล่าวไม่ถูกต้องเกี่ยวกับเมืองเชียงใหม่",
                    choices: [
                        "พระแก้วมรกตเป็นพระคู่บ้านคู่เมืองของเชียงใหม่",
                        "ในอดีตเชียงใหม่เป็นเมืองศูนย์กลางของอาณาจักรล้านนา",
                        "นักบุญที่ชาวเมืองเคารพและศรัทธามากคือ ครูบาศรีวิชัย",
						"ชาวเมืองชอบเข้าวัดทำบุญมากจึงได้ชื่อว่า เชียงใหม่เมืองบุญ"
                    ],
                    correct: 1
				},
				{
					question: "5. ข้อใดไม่ใช่ลักษณะการแต่งกายชุดพื้นเมืองของแม่หญิงเมืองเชียงใหม",
                    choices: [
                        "นุ่งผ้าซิ่นทอมือยาวกรอมเท้า",
                        "นิ้วมือสวมเล็บยาวยกเว้นนิ้วโป้ง",
                        "เสื้อคอกลมแขนกระบอกต่อแขนต่ำ",
						"เกล้ามวยสูงกลางศีรษะทัดดอกไม้หรือปักปิ่น"
                    ],
                    correct: 2
				},
				{
					question: "6. ''ประเพณียี่เป็ง'' ชาวเชียงใหม่จะทำกิจกรรมใด",
                    choices: [
                        "แข่งเรือยาว",
                        "จุดบั้งไฟ",
                        "รดน้ำผู้ใหญ่",
				...
				{
					question: "7. ''ศรัทธาเกื้อหนุน ฟ้อนเล็บฮอมบุญ ต้อนรับครัวทาน'' ข้อความนี้กล่าวถึงงานใด",
                    choices: [
                        "งานปีใหม่เมือง",
                        "จุดบั้งไฟ",
                        "รดน้ำผู้ใหญ่",
				...
				{
					question: "8. ''มีพี่น้องชาวเขา		ม้ง เย้า อาข่า \
									ลีซอ ก็มา 			กะเหรี่ยง ก็มี'' \
									บทกลอนนี้กล่าวถึงชาวเขาทั้งหมดกี่เผ่า",
                    choices: [
                        "4 เผ่า",
                        "5 เผ่า",
                        "6 เผ่า",
				...
				{
					question: "9. ''แอ่วงานปีใหม่'' หมายถึงอะไร",
                    choices: [
                        "จัดงานปีใหม่",
                        "เที่ยวงานปีใหม่",
                        "ทำบุญวันปีใหม่",
				...
				{
					question: "10. “พี่สาวยืนกางจ้องแดงรออยู่หน้าประตูวัด” คำว่า 'กางจ้อง' หมายถึงอะไร",
                    choices: [
                        "กางร่ม",
                        "นุ่งผ้าซิ่น",
                        "สวมหมวก",
