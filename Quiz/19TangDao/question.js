    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. เกิดปัญหาอะไรขึ้นบนดาวฮอฟเฟน",
                    choices: [
                        "สภาวะดาวเอียง",
                        "สภาวะดาวร้อน",
                        "สภาวะดาวมืด"
				...
				{
					question: "2. “ก๊าซออกซิเจน” คืออะไร",
                    choices: [
                        "ก๊าซสังเคราะห์แสง	",
                        "ควันที่ปล่อยมาจากโรงงาน",
                        "ก๊าซที่มนุษย์และสัตว์ใช้หายใจ"
                    ],
                    correct: 3
				},
				{
					question: "3. ดาวฤกษ์เพียงดวงเดียวในระบบสุริยจักรวาลคือข้อใด",
                    choices: [
                        "ดวงจันทร์",
                        "ดวงอาทิตย์",
                        "ดาวเสาร์"
				...
				{
					question: "4. “ดาวเคราะห์สีน้ำเงิน” หมายถึงดาวดวงใด",
                    choices: [
                        "โลก",
                        "ดวงจันทร์",
                        "ดาวอังคาร"
				...
				{
					question: "5. คีริกับคาระไม่ได้มาหาอะไรที่ดาวเคราะห์สีน้ำเงิน",
                    choices: [
                        "แหล่งน้ำ",
                        "นักสำรวจรุ่นแรก",
                        "ตัวผลิตก๊าซออกซิเจน"
				...
				{
					question: "6. โลกหมุนรอบตัวเองใช้เวลากี่ชั่วโมง",
                    choices: [
                        "8 ชั่วโมง",
                        "12 ชั่วโมง",
                        "24 ชั่วโมง"
				...
				{
					question: "7. อุณหภูมิที่สูงขึ้นส่งผลต่อปลวกอย่างไร",
                    choices: [
                        "ขนาดตัวเล็กลง",
                        "ออกไข่ได้มากขึ้น",
                        "ต้องย้ายไปอยู่ในน้ำ"
				...
				{
					question: "8. เครื่องมือแปลงก๊าซคาร์บอนไดออกไซด์ให้เป็นก๊าซออกซิเจนคืออะไร",
                    choices: [
                        "ไส้เดือน",
                        "มนุษย์",
                        "ต้นไม้"
				...
				{
					question: "9. ไส้เดือนให้ของขวัญอะไรแก่คีริกับคาระ",
                    choices: [
                        "น้ำทะเล",
                        "เมล็ดพืช",
                        "ก๊าซออกซิเจน"
				...
				{
					question: "10. เด็ก ๆ สามารถช่วยลดภาวะโลกร้อนได้อย่างไร",
                    choices: [
                        "ปลูกต้นไม้",
