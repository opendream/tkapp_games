    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. เพราะเหตุใด ช้างดื้อจึงไม่มีเพื่อน",
                    choices: [
                        "ตัวใหญ่และตัวเหม็น",
                        "ไม่แบ่งอาหารให้เพื่อนๆ",
                        "ชอบรังแกสัตว์ตัวอื่นๆ",
						"ชอบปลีกตัวไปอยู่ตามลำพัง"
                    ],
                    correct: 3
				},
				{
					question: "2. พ่อช้างและแม่ช้างตักเตือนช้างดื้อว่าอย่างไร",
                    choices: [
                        "อย่าออกไปเดินเล่นที่ป่าอื่น",
                        "ให้ทำความดี เลิกระรานผู้อื่น",
                        "ต้องรู้จักแบ่งปันอาหารให้เพื่อนๆ",
						"รู้จักรักษาความสะอาดของร่างกาย"
                    ],
                    correct: 2
				},
				{
					question: "3. ทำไมช้างดื้อจึงถูกช้างโขลงอื่นรุม",
                    choices: [
                        "ระรานสัตว์ป่าตัวอื่น ๆ ที่กำลังคุยกันอย",
                        "สร้างความเดือดร้อนให้แก่สัตว์ทั่วทั้งป่า",
                        "กินอาหารที่โขลงช้างหามาจนหมดคนเดียว",
						"ส่งเสียงดังรบกวนเวลาพักผ่อนของโขลงช้าง"
                    ],
                    correct: 2
				},
				{
					question: "4. คำว่า 'ไพรสัณฑ์' แปลว่าอะไร",
                    choices: [
                        "ป่า",
                        "ช้าง",
                        "นก",
				...
				{
					question: "5. คำว่า 'หยุดคะนอง' มีความหมายไกล้เคียงกับคำใดมากที่สุด",
                    choices: [
                        "ซึมเศร้า",
                        "สำรวม",
                        "สำนึกผิด",
				...
				{
					question: "6. เด็ก ๆ คิดว่า ช้างดื้อควรประพฤติตัวอย่างไร หลังจากเหตุการณ์น",
                    choices: [
                        "ลิงหลอกเจ้า",
                        "ขวานผ่าซาก",
                        "ทองไม่รู้ร้อน",
				...
				{
					question: "7. ข้อใดมีลักษณะใกล้เคียงกับคำว่า 'แชเชือน' มากที่สุด",
                    choices: [
                        "แก้มเล่นเกมคอมพิวเตอร์จนดึกดื่น",
                        "ขวัญปาลูกบอลใส่เพื่อนแล้ววิ่งหน",
                        "พิมพ์แซงคิวเพื่อนที่กำลังต่อแถวซื้ออาหาร",
						"เลิกเรียนแล้วแต่กานต์ก็เถลไถลไม่ยอมกลับบ้าน"
                    ],
                    correct: 4
				},
				{
					question: "8. เราใช้คำว่า ''โขลง'' กับสัตว์ชนิดใด",
                    choices: [
                        "เม่น",
                        "ช้าง",
                        "นก",
				...
				{
					question: "9. ข้อคิดที่ได้จากเรื่องนี้คือ",
                    choices: [
                        "คนตัวโตกว่าได้เปรียบเสมอ",
                        "คนเกเรไม่มีใครอยากคบหาด้วย",
                        "เพื่อนกินหาง่าย เพื่อนตายหายาก",
						"คนที่แข็งแรงจะได้รับความยำเกรง"
                    ],
                    correct: 2
				},
				{
					question: "10. หากเพื่อนที่เคยรังแกเรามาขอโทษ และขอให้เราช่วยสอนการบ้าน เราจะทำอย่างไร",
                    choices: [
                        "ให้อภัยและช่วยสอนให",
                        "เลี่ยงเดินไปหาเพื่อนคนอื่น",
                        "ไม่สนใจ ก้มหน้าอ่านหนังสือ",
						"บอกให้ไปถามเพื่อนคนอื่นแทน"
                    ],
                    correct: 1
				}
                ],
