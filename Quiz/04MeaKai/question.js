    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. เพราะเหตุใดดารากับรุจีจึงไม่ต้องการให้นันทาออกจากบ้าน",
                    choices: [
                        "เพราะรถจะชนนันทา",
                        "เพราะนันทาจะสกปรก",
                        "เพราะนันทาจะไปจิกเด็กได้",
						"เพราะนันทาอาจติดเชื้อไข้หวัด2009"
                    ],
                    correct: 1
				},
				{
					question: "2. ดารากับรุจีทำอย่างไรเมื่อเห็นนันทากำลังจะมุดออกจากบ้าน",
                    choices: [
                        "จับนันทาไปขังกรงไว้",
                        "ทำโทษโดยให้อาหารเย็นช้า",
                        "บอกให้พ่อนันทาไปปล่อย",
						"นำก้อนหินมาอุดช่องใต้ประตู"
                    ],
                    correct: 1
				},
				{
					question: "3. นันทารู้สึกอย่างไร ที่ออกนอกบ้านไม่ได้เพราะมีกิ่งไม้ขวางประตูอยู่",
                    choices: [
                        "โกรธ",
                        "เสียใจ",
                        "ผิดหวัง",
				...
				{
					question: "4. นันทาหนีดารากับรุจีออกไปที่ถนนได้อย่างไร",
                    choices: [
                        "บอกบุรุษไปรษณีย์ให้ช่วยอุ้มออกไป",
                        "เดินออกไปเมื่อบุรุษไปรษณีย์เปิดประต",
                        "แอบเดินตามกระเป๋าบุรุษไปรษณีย์ออกไป",
						"มุดประตูออกไปหลังจากบุรุษไปรษณีย์เอากิ่งไม้ออก"
                    ],
                    correct: 4
				},
				{
					question: "5. ''ถ้านันทาออกไปที่ถนน มันคงถูกรถทับตายเท่านั้นเอง'' ประโยคนี้แสดงให้เห็นว่า รุจีกับดารามีนิสัยอย่างไร",
                    choices: [
                        "เป็นมิตร",
                        "ชอบช่วยเหลือ",
                        "จิตใจอ่อนโยน",
				...
				{
					question: "6. เพราะเหตุใดนันทาจึงถูกรถทับตาย",
                    choices: [
                        "ความโลภ",
                        "ความประมาท",
                        "ความเกียจคร้าน",
				...
				{
					question: "7. รุจีกับดารารู้สึกอย่างไรเมื่อเห็นนันทาถูกรถทับ",
                    choices: [
                        "เสียใจที่นันทาตาย",
                        "โกรธเคืองคนขับรถชน",
                        "น้อยใจที่นันทาไม่เชื่อฟัง",
						"ผิดหวังที่พ่อไม่่วยนันทา"
                    ],
                    correct: 1
				},
				{
					question: "8. ''แสนเสียดาย นันทา ที่น่ารัก \
									ชะล่านัก เลี่ยงออก นอกถนน \
					    			มัวแต่เพลิน ปลาบปลื้ม จนลืมตน \
					    			ถูกรถยนต์ แล่นทับ ดับชีวา'' จากบทกลอนอาลัยบทนี้ นันทาตายเพราะเหตุใด",
                    choices: [
                        "ความปลื้มใจของนันทา",
                        "ความอ่อนแอของนันทา",
                        "ความหลงระเริงของนันทา",
						"ความหลงตัวเองของนันทา"
                    ],
                    correct: 3
				},
				{
					question: "9. นอกจากเลี้ยงไก่ไว้ในกรงแล้ว เราสามารถเลี้ยงไก่ได้ที่ไหนบ้าง",
                    choices: [
                        "รัง",
                        "เล้า",
                        "กล่อง",
				...
				{
					question: "10. ข้อคิดที่ได้จากนิทานเรื่องนี้ตรงกับสุภาษิตในข้อใด",
                    choices: [
                        "กล้านักมักบิ่น",
                        "ดินพอกหางหมู",
                        "เข็นครกขึ้นภูเขา",
