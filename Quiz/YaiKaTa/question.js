    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
				...
				{
					question: "3. หลานให้ใครมากัดสายธนูนายพราน",
                    choices: [
                        "กา",
                        "แมว",
                        "หนู",
				...
				{
					question: "4. หลานให้ช้างไปทำอะไร",
                    choices: [
                        "กัดสายธนู",
                        "พังตลิ่ง",
                        "ดับไฟ",
				...
				{
					question: "5. การ์ตูน ยายกะตา ได้ข้อคิดอะไร",
                    choices: [
                        "ควรหวังพึ่งผู้อื่น",
                        "ขยันเรียน",
                        "ไม่ควรหวังพึ่งผู้อื่น",
						"ควรวางแผนงาน"
                    ],
                    correct: 3
				}
