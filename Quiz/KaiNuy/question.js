    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. ไข่นุ้ยกับเจ๊หมวยเอาอะไรไปฝากเป๊าะจ",
                    choices: [
                        "ส้มโอ",
                        "สับปะรด",
                        "กล้วยน้ำว้า"
				...
				{
					question: "2. ที่เมืองยะลานิยมเลี้ยงสัตว์ชนิดใด",
                    choices: [
                        "แกะ",
                        "แพะ",
                        "ม้า"
				...
				{
					question: "3. ทำไมไข่นุ้ยจึงมีหน้าตาเศร้าและไม่พูดจากับเป๊าะจิ๊",
                    choices: [
                        "ไม่มีเพื่อนเล่น",
                        "ถูกเป๊าะจิ๊ดุเอา",
                        "ไม่เจอแพะน้อยหลายวัน"
                    ],
                    correct: 3
				},
				{
					question: "4. ''วันฮารีรายอ'' คือวันอะไร",
                    choices: [
                        "วันแห่งความปีติยินดี",
                        "วันแห่งการเที่ยวสนุก",
                        "วันแห่งการพักผ่อน"
                    ],
                    correct: 1
				},
				{
					question: "5. ''ไข่นุ้ยรู้สึกเสียใจ เพราะเข้าใจว่าแพะน้อยโดนเชือด'' ไข่นุ้ยมีนิสัยอย่างไร",
                    choices: [
                        "รักสัตว์",
                        "อ่อนแอ",
                        "มีน้ำใจ"
				...
				{
					question: "6. ชาวมุสลิมต้องละหมาดวันละกี่ครั้ง",
                    choices: [
                        "3 ครั้ง",
                        "5 ครั้ง",
                        "7 ครั้ง"
				...
				{
					question: "7. ''ซลามัตฮารีรายอ'' ที่ชาวมุสลิมพูดทักทายกัน แปลว่าอะไร",
                    choices: [
                        "ขออภัยวันฮารีรายอ",
                        "สวัสดีวันฮารีรายอ",
                        "มีความสุขในวันฮารีรายอ"
                    ],
                    correct: 2
				},
				{
					question: "8. ''มีมากให้มาก มีน้อยให้น้อย'' เกี่ยวข้องกับอะไร",
                    choices: [
                        "การขายของ",
                        "การให้ทาน",
                        "การให้อภัย"
				...
				{
					question: "9. ''ชาวมุสลิม'' คือผู้ที่นับถือศาสนาใด",
                    choices: [
                        "คริสต์",
                        "พุทธ",
                        "อิสลาม"
				...
				{
					question: "10. ทำไมเราต้องสวมหมวกกันน็อกทุกครั้งเมื่อนั่งรถมอเตอร์ไซค์",
                    choices: [
                        "เพื่อความปลอดภัย",
                        "เพื่อความสวยงาม",
                        "เพื่อความสนุกสนาน"
