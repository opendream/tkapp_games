    ...
    var director = new lime.Director(document.body, 800, 600),
        ...
        setupChoice = function (scene) {
            var board = new lime.Sprite(),
                ...
                choice = [
				{
					question: "1. นางจันทร์เทวี คลอดลูกเป็นอะไร",
                    choices: [
                        "หอยสังข์",
                        "หอยมุข",
                        "หอยขม",
				...
				{
					question: "2. นางจันทร์เทวี พาลูกเข้าไปอาศัยกับใคร",
                    choices: [
                        "พ่อ แม่",
                        "พี่ น้อง",
                        "ปู่ ย่า",
				...
				{
					question: "3. ใครแอบช่วยงานบ้าน ตอนที่นางจันทร์เทวีไม่อยู่",
                    choices: [
                        "ตา ยาย",
                        "พระราชา",
                        "พระสังข์",
				...
				{
					question: "4. นางจันทาให้คนมาฆ่าพระสังข์แต่ไม่เป็นอะไรเพราะสาเหตุใด",
                    choices: [
                        "พระสังข์หนีทัน",
                        "พระสังข์เป็นผู้มีบุญ",
                        "พระสังข์มีชุดเกราะ",
						"พระสังข์มีคนมาช่วย"
                    ],
                    correct: 2
				...
				{
					question: "5. พระสังข์ไปที่ปราสาทใหญ่แล้วได้อะไร",
                    choices: [
                        "ได้เสื้อชุดใหม่",
                        "ได้ของเล่นใหม่",
                        "รูปเงาะ รองเท้าแก้ว และไม้เท้าทอง",
						"ได้ของวิเศษ"
                    ],
                    correct: 3
				}
