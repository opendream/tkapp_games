var game_func = function () {
  ...
  game.secondScene = function() {
    ...
    {
      num:5,
      position:[{x:80,y:110},{x:90,y:0},{x:150,y:50},{x:0,y:50},{x:240,y:50}],
      correct:[0,0,0,0,0],
      ...
      {
      num:4,
      position:[{x:100,y:30},{x:75,y:150},{x:170,y:195},{x:240,y:160}],
      correct:[0,0,0,0],
    ...
    {
      num:4,
      position:[{x:75,y:75},{x:35,y:110},{x:60,y:210},{x:177,y:140}],
      correct:[0,0,0,0],
    ...
    {
      num:4,
      position:[{x:210,y:30},{x:65,y:50},{x:80,y:230},{x:230,y:130}],
      correct:[0,0,0,0],
