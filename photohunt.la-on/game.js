var game_func = function () {
  ...
  game.secondScene = function() {
    ...
    {
      num:5,
      position:[{x:0,y:0},{x:90,y:30},{x:50,y:180},{x:140,y:175},{x:155,y:80}],
      correct:[0,0,0,0,0],
    ...
    {
      num:5,
      position:[{x:0,y:230},{x:185,y:100},{x:40,y:210},{x:100,y:0},{x:125,y:250}],
      correct:[0,0,0,0,0],
      ...
      rightImage:"assets/images/problems/image2b.jpg"
        ...
        {
      num:5,
      position:[{x:50,y:80},{x:10,y:120},{x:10,y:230},{x:160,y:60},{x:150,y:140}],
      correct:[0,0,0,0,0],
    ...
    {
      num:5,
      position:[{x:160,y:60},{x:0,y:170},{x:200,y:200},{x:140,y:220},{x:250,y:30}],
      correct:[0,0,0,0,0],
    ...
    {
      num:5,
      position:[{x:5,y:5},{x:70,y:40},{x:50,y:140},{x:140,y:150},{x:230,y:200}],
      correct:[0,0,0,0,0],
      ...
      {
      num:7,
      position:[{x:145,y:0},{x:0,y:120},{x:10,y:230},{x:140,y:150},{x:200,y:10},{x:230,y:160},{x:70,y:70}],
    ...
    {
      num:7,
      position:[{x:10,y:10},{x:110,y:50},{x:70,y:180},{x:120,y:200},{x:165,y:20},{x:230,y:30},{x:0,y:220}],
      correct:[0,0,0,0,0,0,0],
    ...
    {
      num:7,
      position:[{x:10,y:0},{x:0,y:100},{x:0,y:220},{x:80,y:190},{x:240,y:0},{x:110,y:80},{x:180,y:180}],
      correct:[0,0,0,0,0,0,0],
     ...
     {
      num:7,
      position:[{x:240,y:10},{x:50,y:0},{x:50,y:240},{x:70,y:60},{x:170,y:150},{x:240,y:200},{x:0,y:90}],
      correct:[0,0,0,0,0,0,0],
  ...
  while(order.length < questionLength){
    ...
    var getShowingLayer = function() {
      ...
      if(questions[order[queueIndex]]["num"] == 7){
            for(var i = 0 ; i<questions[order[queueIndex]]["num"] ; i++){
                correctImage.push(new lime.Sprite().setSize( 50, 50 ).setPosition(
                    (i<4) ? 
                        sceneCenterX+(sceneCenterX/4)+(i*60)-20 : sceneCenterX+(sceneCenterX/4)+((i-4)*60)+20 ,
                    (i<4) ? 
